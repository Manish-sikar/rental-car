...
$(function () {
  ...
  if (dt_basic_table.length) {
    dt_basic = dt_basic_table.DataTable({
      ajax: customPath + "json/subject.json",
      columns: [
        { data: "" },
        { data: "id" },
        { data: "id" },
        ...
        { data: "paper_topic" },
        { data: "paper_type" },
        { data: "max_internal_marks" },
        { data: "max_practical_marks" },
        { data: "" },
      ],
      columnDefs: [
        {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var subject_name = full["subject_name"];
        ...
        },
        {
          ...
          targets: -2,
          render: function (data, type, full, meta) {
            var $max_practical_marks = full["max_practical_marks"];

            return "<span>" + $max_practical_marks + "</span>";
          },
        },
        {
          // Label
          targets: -3,
          render: function (data, type, full, meta) {
            var $max_internal_marks = full["max_internal_marks"];

            return "<span>" + $max_internal_marks + "</span>";
          },
        },
